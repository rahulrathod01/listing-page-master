...
export class HomePageComponent implements OnInit {
  ...
  getUserData() {
    ...
    this.httpSvc.fetchUserInfo(this.name.value).subscribe(data => {
      ...
      this.userData.bio = data.body.bio ? data.body.bio : 'Bio will be here';
      this.userData.company = data.body.company ? data.body.company : 'student';
      this.userData.location = data.body.location ? data.body.location : 'Hyderabad';
